...
namespace NGettext
{
    ...
    public class Catalog : ICatalog
    {
        ...
        {
            bool usetranslation;
            return GetString(text, out usetranslation);
        }

        public string GetString(string text, params object[] args)
        {
            bool useTranslation;
            return GetString(text, useTranslation: out useTranslation, args: args);
        }

        public string GetPluralString(string text, string pluralText, long n)
        {
            bool useTranslation;
            return GetPluralString(text, pluralText, n, out useTranslation);
        }

        public string GetPluralString(string text, string pluralText, long n, params object[] args)
        {
            bool useTranslation;
            return GetPluralString(text, pluralText, n, useTranslation: out useTranslation, args: args);
        }

        public string GetParticularString(string context, string text)
        {
            bool useTranslation;
            return GetParticularString(context, text, out useTranslation);
        }

        public string GetParticularString(string context, string text, params object[] args)
        {
            bool useTranslation;
            return GetParticularString(context, text, out useTranslation, args: args);
        }

        public string GetParticularPluralString(string context, string text, string pluralText, long n)
        {
            bool useTranslation;
            return GetParticularPluralString(context, text, pluralText, n, out useTranslation);
        }

        public string GetParticularPluralString(string context, string text, string pluralText, long n, params object[] args)
        {
            bool useTranslation;
            return GetParticularPluralString(context, text, pluralText, n, useTranslation: out useTranslation, args: args);
        }
    }
}